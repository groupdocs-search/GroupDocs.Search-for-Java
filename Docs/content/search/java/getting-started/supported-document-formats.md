...
| XLSB | Office Open XML Spreadsheet \[Binary\] | ![(tick)](search/java/images/check.png) | ![(tick)](search/java/images/check.png) |   |   |   |
...
| JP2 | JPEG 2000 Core Image File |   | ![(tick)](search/java/images/check.png) |   |   |   |
